...
/**
 * Servlet implementation class ReportBinarioPDF
 */
@WebServlet("/ReportBinarioPDF")
public class ReportBinarioPDF extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			JasperPrint printer = JasperFillManager.fillReport( is, null, source );
