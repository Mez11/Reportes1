...
/**
 * Servlet implementation class ReporteBinarioPDF
 */
@WebServlet("/ReporteBinarioPDF")
public class ReporteBinarioPDF extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private static final String RUTA_JASPER = "/WEB-INF/classes/mx/ipn/web/report/ListaEscuela.jasper"; //Change
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ReporteBinarioPDF() {
        super();
